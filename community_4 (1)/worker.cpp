...
Worker::Worker(QWidget *parent) : BaseWindow(parent), ui(new Ui::Worker)
{
    ui->setupUi(this);
...
void Worker::on_pushButtonClose_clicked()
{
    close();
}

void Worker::on_pushButtonMinimize_clicked()
{
    setWindowState(Qt::WindowMinimized);
}

void Worker::on_pushButtonBack_clicked()
{
    this->hide(); // 隐藏当前窗口
